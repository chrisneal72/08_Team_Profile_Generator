...
async function render(employees) {
  ...
  await writeFile(
    ...
    replacePlaceholder(mainTemplate, "manager", managerHtml.join(""))
    replacePlaceholder(mainTemplate, "engineer", engineerHtml.join(""))
    replacePlaceholder(mainTemplate, "initern", internHtml.join(""))
  );
}
